...
$(function() {
  ...
  var web3 = new Web3(new Web3.providers.HttpProvider("https://rpc2.mix-blockchain.org:8647"));
    ...
    if (error) {
      ...
      web3.eth.getBlock('latest', function(error, result) {
        if (error) {
          ...
          $("#crowdfund-section #current-rate").text(rate.toLocaleString() + " MIX per day");
  ...
  link_revenue_sol_linkrevenue.getReleased(function(error, result) {
    if (error) {
      ...
      Highcharts.chart('chart2', {
        ...
        tooltip: {
            pointFormat: '<b>{point.y} MIX</b> ({point.percentage:.1f}%)'
        },
        plotOptions: {
            pie: {
